...
## EAP773 Access Points (WiFi 7) x2

### Inventory

| Name | IP | MAC | Switch Port | Location |
|------|-----|-----|-------------|----------|
| DownstairsAP | 192.168.1.242 | 20-36-26-DD-7E-E0 | Port 8 | Downstairs |
| UpstairsAP | 192.168.1.22 | A8-29-48-C0-01-60 | Port 3 | Upstairs |
...
| Firmware | 1.2.0 Build 20260113 Rel. 72533 |
...
## EAP225 Access Point (Attic AP)

### Inventory

| Name | IP | MAC | Switch Port | Location |
|------|-----|-----|-------------|----------|
| Attic AP | 192.168.1.109 | 78-20-51-D8-FA-48 | - | Attic |
...
```
                     ...
                     Port 3│ Port 8│     │
            ┌──────────────┴┐ ┌───┴──────────┐ ┌──────────────┐
            │   EAP773      │ │   EAP773     │ │   EAP225     │
            │ (UpstairsAP)  │ │(DownstairsAP)│ │  (Attic AP)  │
            │ 192.168.1.22  │ │192.168.1.242 │ │192.168.1.109 │
            │   WiFi 7      │ │   WiFi 7     │ │   WiFi 5     │
            └───────────────┘ └──────────────┘ └──────────────┘
```
